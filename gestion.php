          ...
          <div class="col-md-5 cadre">
            <h2 class="text-center pb-3 mt-4">Historique de l'association</h2>
              ...
              <p class="fs-5 lh-sm">
                ...
                <img src="./assets/img/debutChantier.png" alt="Pelleteuse du chantier" class="rounded p-4 w-75">  
    ...
    <section>
      <div class="container">
        <div class="row cadre"> 
          ...
          <!-- Personnel -->
          <div class="col-md-5">
            <h2 class="pt-5 mb-5 ms-5">Présentation de l'équipe</h2>

            <div class="col">
              <img src="./assets/img/Mr Dupond.jpg" alt="Mr Dupond" style="width: 9rem; margin-left: 3rem;" class="rounded rounded-circle">
              <div class="d-inline-block">
                <h4 class="ps-4 mb-1">Président</h4>
                <p class="ps-3 text-center">Monsieur Dupond</p> 
              </div>
            </div>

            <div class="col my-5">
              <div class="d-inline-block">
                <h4 class="ps-5 mb-1">Vice Président</h4>
                <p class="ps-5 text-center">Monsieur Gerland</p>
              </div>
              <img src="./assets/img/Mr Gerland.jpg" alt="Mr Gerland" style="width: 9rem ;"class="rounded-circle ms-3">
            </div>
           
           
            <div class="col my-5">
              <img src="./assets/img/Monsieur Launay.jpg" alt="Monsieur Launay" style="width: 9rem; margin-left: 3rem ;"class="rounded-circle ms-5">
              <div class="d-inline-block">
                <h4 class="ps-4 mb-1">Trésorier</h4>
            ...
            <div class="col my-5">
              <div class="d-inline-block">
                <h4 class="ps-5 mb-1">Secrétaire</h4>
                <p class="ps-5 text-center">Madame Thomas</p>
              </div>
              <img src="./assets/img/Mme Thomas.jpg" alt="Madame Thomas" class="w-25 rounded-circle ms-3">
            </div>
              ...
              <div class="col-md-7">
                ...
                <h4>Vente de graine et plants</h4>
                <p class="fs-5 lh-sm">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="card imgSideToSide" style="width: 6rem;">
                        ...
                        <div class="card-body">
                          <h6 class="card-title m-0 text-nowrap">Courgette</h6>
                        </div>
                      </div>
                      ...
                      <div class="card imgSideToSide" style="width: 6rem;">
                        ...
                        <div class="card-body">
                          <h6 class="card-title m-0 text-nowrap">Pomme de terre</h6>
                        </div>
                      </div>
                      ...
                      <div class="card imgSideToSide" style="width: 6rem;">
                        ...
                        <div class="card-body">
                          <h6 class="card-title m-0 text-nowrap">Salade</h6>
                        </div>
                      </div>
                    ...
                    <div class="my-5">
                        ...
                        <div class="row">
                          <h2 class="text-center pb-3">Personnel de l'amicale</h2>
                          <div class="col-md-6">
